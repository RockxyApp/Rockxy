...
## უახლესი ტეგირებული გამოცემა

**v0.27.2** — 2026-06-18

### შეიცვალა

- გააძლიერეთ მეტამონაცემების კონფიდენციალურობის კონტროლი
- მეტამონაცემების გამჟღავნების განლაგების დახვეწა

იხ [CHANGELOG.md](CHANGELOG.md) სრული გამოშვების ისტორიისთვის.
