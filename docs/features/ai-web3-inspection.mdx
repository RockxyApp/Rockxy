...
<Note>
This page covers inspection of traffic sent to AI and Web3 services. To ask questions about any selected captured request, see [AI Assistant](/features/ai-assistant).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="AI Assistant" icon="comments" href="/features/ai-assistant">
    Analyze selected captured traffic with explicit review before model access.
  </Card>
</CardGroup>
